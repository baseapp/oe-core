...
WARN_QA ?= "ldflags useless-rpaths rpaths unsafe-references-in-binaries unsafe-references-in-scripts staticdev debug-files"
ERROR_QA ?= "dev-so debug-deps dev-deps arch la2 pkgconfig la perms"
